  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 z-10">
        ...
        >
          ...
          <div className="flex items-center gap-5 text-xs tracking-wide">
            <span className="hidden sm:inline font-mono text-[11px] opacity-60">
              DIGITAL EXHIBITION · 2024—2026 ARCHIVE
            </span>
        ...
        {/* Hero Grid: Prominent Display Typography + Live Specimen Window */}
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`inline-flex items-center gap-1.5 font-mono text-[10px] px-2.5 py-0.5 rounded-full border ${
                    isDark
            ...
            <div className="sm:pl-6 lg:pl-10 space-y-3 pt-1">
              ...
              <p className="text-[15px] sm:text-[16px] opacity-75 font-sans leading-relaxed max-w-xl font-light">
                Every entry in this archive is a verified piece of software—combining paper-grade typographic restraint with production-ready execution. Explore real captures and media directly in each exhibit.
              </p>
            </div>

            {/* Fast Action & Exhibition Navigation */}
            <div className="sm:pl-6 lg:pl-10 pt-2 flex flex-wrap items-center gap-6 text-xs uppercase tracking-[0.16em] font-mono">
              <MagneticLink strength={4}>
                <button
                  ...
                  className={`group inline-flex items-center gap-2.5 px-6 py-3.5 transition-colors cursor-pointer text-[12px] uppercase tracking-[0.18em] font-medium shadow-xs rounded-xs ${
                    isDark
                      ? 'bg-violet-600 text-[#030014] hover:bg-violet-400 font-semibold'
                      : 'bg-[#171717] text-[#FAF9F5] hover:bg-[#8B5CF6]'
                  }`}
                >
                  <span>explore exhibition ({projectsData.length})</span>
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-between pb-2.5 text-[11px] font-mono uppercase tracking-[0.18em] opacity-75">
                <span className="flex items-center gap-1.5 font-medium text-current">
                  ...
                  <span>featured exhibit specimen</span>
                </span>
              ...
              {/* Project Media Frame wrapping the featured project */}
